...
define('SERVERPORT','8080');//3306
define('DBUSERNAME','root');  // Replace root with your database username. If unsure, leave as is.
define('DBPASSWORD','');	// Replace root with your database user password.
define('DBNAME','Qwench'); 	//Create a new database qwench on your server and replace YOUR_DB with it's name
