...
<div style="float:right;border-left: 1px solid #13a1c9;border-right: 1px solid #45c9e9;"><ol><li><a href="<?php echo basePath();?>/">ප්‍රධාන පිටුව</a></li><li><a href="<?php echo basePath();?>/questions">ප්‍රශ්ණ</a></li><li><a href="<?php echo basePath();?>/tags">ටැග්</a></li><li><a href="<?php echo basePath();?>/users">පරිශීලකයන්</a></li><li><a href="<?php echo basePath();?>/questions?type=unanswered">නොවිසඳුනු</a></li><li><a href="<?php echo basePath();?>/questions/ask">අසන්න හෝ දායක වන්න</a></li></ol></div>
